...
abstract class SignInRequested implements AuthEvent {
  const factory SignInRequested(final String email, final String password) =
...
class _$SignUpRequestedImpl implements SignUpRequested {
  const _$SignUpRequestedImpl(this.email, this.password);
...
abstract class SignUpRequested implements AuthEvent {
  const factory SignUpRequested(final String email, final String password) =
